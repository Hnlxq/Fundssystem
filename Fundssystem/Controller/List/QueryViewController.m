...
{
    // 数据
    NSArray *images = @[@"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory", @"icon_homepage_moreCategory"];
    NSArray *titles = @[@"结算单汇总统计图", @"机票销售汇总统计图查询", @"合同信息查询", @"作业通知单查询",@"工作量签证单",@"暂估单查询",@"结算单查询",@"合同执行分析查询",@"单位合同综合",@"分类合同综合",@"单位预算综合",@"公司预算综合"];
    ...
    for (int i = 0; i < count; i++) {
        ...
        button.frame = CGRectMake(i%maxColsCount * buttonW, (i)/maxColsCount * buttonW + SCREENHEIGHT *0.25, buttonW, buttonW );
