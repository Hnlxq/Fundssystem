...
//
    ...
    MeTabBarViewController *mainVC = [[MeTabBarViewController alloc]init];
     UINavigationController *mainNav = [[MeNavigationController alloc] initWithRootViewController:mainVC];
